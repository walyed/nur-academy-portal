...
export default function MonthlyCalendar({ slots, onSlotClick, editable = false }: MonthlyCalendarProps) {
  ...
  const getDateStatus = (date: Date): 'available' | 'booked' | 'mixed' | 'none' => {
      ...
      <div className="lg:w-72 bg-[hsl(220_20%_97%)] rounded-xl p-4">
        ...
        {selectedDate ? (
          selectedDateSlots.length > 0 ? (
              ...
              {selectedDateSlots.map(slot => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    `} />
                    <span className="font-medium text-[hsl(220_25%_25%)]">{slot.time}</span>
                  </div>
            ...
            <p className="text-sm text-[hsl(220_10%_50%)]">No slots for this date</p>
          )
        ) : (

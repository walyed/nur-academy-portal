...
function ChatContent() {
  ...
  const handleSend = async () => {
    ...
    try {
      const message = await api.sendMessage(selectedContact.id, newMessage);
  ...
  if (loading) {
    return (
      <div className="max-w-5xl mx-auto p-5 mt-10 text-center">Loading...</div>
    );
  }

  return (
    <div className="max-w-5xl mx-auto p-5" style={{ marginTop: "40px" }}>
      <div
        className="flex rounded-2xl overflow-hidden shadow-xl"
        style={{ background: "white", border: "1px solid hsl(220 15% 92%)" }}
      >
        <div

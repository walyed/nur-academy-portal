  ...
  const features = [
    {
      icon: "👨‍🏫",
      title: "Expert Tutors",
      desc: "Learn from qualified professionals in various subjects",
    },
    {
      icon: "📅",
      title: "Easy Booking",
      desc: "Schedule sessions that fit your availability",
    },
    {
      icon: "💬",
      title: "Direct Chat",
      desc: "Communicate with tutors before and after sessions",
    },
    {
      icon: "⭐",
      title: "Rated Reviews",
      desc: "Choose tutors based on student feedback",
    },
  ];
    ...
    <div>
      <section
        style={{
          padding: "80px 20px",
          background:
            "linear-gradient(135deg, hsl(210 60% 98%) 0%, hsl(210 50% 94%) 100%)",
          textAlign: "center",
        }}
      >
        <div style={{ maxWidth: "700px", margin: "0 auto" }}>
          ...
          >
            Find Your Perfect{" "}
            <span style={{ color: "hsl(210 60% 45%)" }}>Tutor</span>
          </h1>
          ...
          >
            Connect with expert tutors, book sessions easily, and achieve your
            learning goals. Nur Academy makes quality education accessible to
            everyone.
          </p>
      ...
      >
        ...
        >
          ...
          <div>
            <h4
              style={{ color: "white", marginBottom: "16px", fontSize: "14px" }}
            >
              Platform
            </h4>
            <ul
